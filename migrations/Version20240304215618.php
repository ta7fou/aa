 ...
 */
final class Version20240304215618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture ADD user_id INT DEFAULT NULL, ADD prixtotal INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP user_id, DROP prixtotal');
    }
}
